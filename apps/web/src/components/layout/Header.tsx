...
import { ShieldCheck, LogOut, Wallet, Settings } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = () => {
  ...
  const { isAuthenticated, user, openAuthModal, logout, openCashier, openAccountSettings } = useAuth();
        ...
        >
          ...
          >
            ...
            >
                ...
                >
                  <div className="design-system-enterprise-copy--navbar_menu-wrapper">
                    <div className="design-system-enterprise-copy--navbar_menu-content">
                      ...
                      {/* Deriv Bot (Directed to user's Deriv bot) */}
                      <a
                        data-wf--design-system-enterprise-copy--navbar-link--variant="base"
              ...
              {/* Inner Desktop Buttons (ProfileDropdown when logged in, or Login & Open Account) */}
              {isDesktop && (
                <div
                  className="design-system-enterprise-copy--navbar_menu-side-buttons"
                  style={{
                    maxWidth: isScrolled ? '0px' : (isAuthenticated ? '280px' : '300px'),
                    opacity: isScrolled ? 0 : 1,
                    overflow: 'visible',
                    whiteSpace: 'nowrap',
                    pointerEvents: isScrolled ? 'none' : 'auto',
                        ...
                        <div className="design-system-enterprise-copy--auth_wrapper">
                          <div className="design-system-enterprise-copy--auth_button_wrapper">
                            <button
                              ...
                              className="design-system-enterprise-copy--button w-variant-ace358d6-1840-0bfe-ab5a-550a9f42a890 w-inline-block cursor-pointer"
                            >
              ...
              {/* Mobile Right Controls (Profile Dropdown or Login Pill + Burger Toggle) */}
              {!isDesktop && (
                  ...
                  {isAuthenticated ? (
                    ...
                    <div className="design-system-enterprise-copy--navbar_mobile-login">
                      <button
                        ...
                        data-dwp-button="login"
                        onClick={() => openAuthModal('login')}
                        className="design-system-enterprise-copy--button design-system-enterprise-copy--is-black design-system-enterprise-copy--is-border-black design-system-enterprise-copy--navbar_login-button w-inline-block cursor-pointer"
                        style={{
                      ...
                      <div className="design-system-enterprise-copy--auth_wrapper">
                        <div className="design-system-enterprise-copy--auth_button_wrapper">
                          <button
                            ...
                            onClick={() => openAuthModal('login')}
                            className="design-system-enterprise-copy--button w-variant-ace358d6-1840-0bfe-ab5a-550a9f42a892 w-inline-block cursor-pointer"
                          >
                            <div data-traking="button-text" className="design-system-enterprise-copy--button_text">
                              Log in
                            </div>
            ...
            {isAuthenticated && user ? (
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className="py-2.5 px-3 bg-red-50 text-[#FF444F] font-bold rounded-xl text-xs flex items-center justify-center gap-1.5"
                  >
                  ...
                  <button
                    ...
                    className="py-2.5 px-3 bg-gray-100 text-gray-700 font-bold rounded-xl text-xs flex items-center justify-center gap-1.5"
                  >
                ...
                <button
                  ...
                  className="w-full py-2.5 border border-red-200 text-[#FF444F] hover:bg-red-50 font-bold text-xs rounded-xl flex items-center justify-center gap-1.5 transition-colors"
                >
              ...
              <>
                <button
                  ...
                  className="w-full py-3.5 px-4 bg-[#ff444f] hover:bg-[#eb3e48] text-white text-center font-bold text-[15px] rounded-full transition-colors shadow-sm cursor-pointer"
                >
                  Open account
                </button>
                <button
                  ...
                  className="w-full py-3 px-4 border border-[#111111] text-[#111111] hover:bg-gray-50 text-center font-bold text-[15px] rounded-full transition-colors cursor-pointer"
                >
                  Log in
                </button>
              </>
